...
default_data = [("Erling Haaland",30 , 28, 8),
    ("Viktor Gyokeres",19 , 17.5, 3),
    ("Jean-Philippe Mateta",14.5 , 13, 2),
    ("Mohamed Salah",14.5 , 13, 2),
    ("Alexander Isak",14 , 12.5, 0),
    ("Antoine Semenyo",13.5 , 12.5, 4),
    ("Cole Palmer",14 , 12.5, 1),
    ("Nick Woltemade",13.5 , 12, 2),
    ("Joao Pedro",13 , 11.5, 2),
    ("Igor Thiago",12 , 11, 2),
    ("Ollie Watkins",12.5 , 11, 1),
    ("Hugo Ekitike",11.5 , 10.5, 3),
    ...
    ("Beto",10.5 , 9.5, 1),
    ("Bruno Fernandes",10.5 , 9.5, 2),
    ("Dominic Solanke",10 , 9, 0),
    ("Benjamin Sesko",10 , 9, 1),
    ("Ismaila Sarr",9.75 , 8.75, 3),
    ("Anthony Gordon",9.75 , 8.75, 0),
    ("Omar Marmoush",9.75 , 8.75, 0),
    ("Danny Welbeck",9.75 , 8.75, 2),
    ("Wilson Isidor",9.5 , 8.5, 3),
    ("Liam Delap",9.5 , 8.5, 0),
    ("Jorgen Strand Larsen",9.25 , 8.25, 0),
    ("Iliman Ndiaye",9.25 , 8.25, 2),
    ("Enzo Fernandez",9.25 , 8.25, 3),
    ("Dominic Calvert-Lewin",8.75 , 7.75, 1),
    ("Kai Havertz",8.75 , 7.75, 0),
    ("Phil Foden",8.75 , 7.75, 1),
    ("Bryan Mbeumo",8.5 , 7.5, 1),
    ("Cody Gakpo",8.5 , 7.5, 1),
