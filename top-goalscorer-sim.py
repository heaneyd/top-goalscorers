...
default_data = [    
    (" Erling Haaland       ",25 , 23, 3),
    (" Viktor Gyokeres      ",19 , 17.5, 2),
    (" Mohamed Salah        ",16.5 , 15, 1),
    (" Alexander Isak       ",15.5 , 14, 0),
    (" Joao Pedro           ",14 , 12.5, 2),
    (" Jean-Philippe Mateta ",13.5 , 12, 1),
    (" Chris Wood           ",13.5 , 12, 2),
    (" Ollie Watkins        ",13 , 11.5, 0),
    (" Cole Palmer          ",13 , 11.5, 0),
    (" Igor Thiago          ",12.25 , 11.25, 2),
    (" Evanilson            ",12.5 , 11, 1),
    (" Hugo Ekitike         ",11.5 , 10.5, 2),
    ...
    (" Jorgen Strand Larsen ",10.5 , 9.5, 0),
    (" Nick Woltemade       ",10 , 9, 0),
    (" Dominic Solanke      ",10 , 9, 0),
    (" Omar Marmoush        ",9.75 , 8.75, 0),
    (" Benjamin Sesko       ",9.75 , 8.75, 0),
    (" Iliman Ndiaye        ",9.5 , 8.5, 2),
    (" Liam Delap           ",9.5 , 8.5, 0),
    (" Eberechi Eze         ",9.25 , 8.25, 0),
    (" Anthony Gordon       ",9.25 , 8.25, 0),
    (" Richarlison          ",9.25 , 8.25, 2),
    (" Cody Gakpo           ",9.25 , 8.25, 1),
    (" Bryan Mbeumo         ",9.25 , 8.25, 1),
    (" Matheus Cunha        ",9 , 8, 0),
    (" Brennan Johnson      ",9 , 8, 2),
    (" Tijjani Reijnders    ",8.75 , 7.75, 1),
    (" Kai Havertz          ",8.75 , 7.75, 0),
    (" Ismaila Sarr         ",8.5 , 7.5, 2),
    (" Raul Jimenez         ",8.5 , 7.5, 0),
    (" Beto                 ",8.5 , 7.5, 1),
